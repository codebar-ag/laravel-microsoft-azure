...
> **Design note (historical):** background on the ARM/REST refactor that replaced PowerShell/Bicep provisioning. For current usage, see [docs/usage.md](usage.md) and [docs/advanced.md](advanced.md).
