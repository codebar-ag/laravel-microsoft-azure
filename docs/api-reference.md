...
| api_management | PUT | `/subscriptions/{subscriptionId}/resourceGroups/{rg}/providers/Microsoft.ApiManagement/service/{name}/subscriptions/{sid}` | `CodebarAg\MicrosoftAzure\Requests\Arm\ApiManagement\Subscriptions\CreateOrUpdateApimSubscription` |
| api_management | GET | `/subscriptions/{subscriptionId}/resourceGroups/{rg}/providers/Microsoft.ApiManagement/service/{name}/subscriptions/{sid}` | `CodebarAg\MicrosoftAzure\Requests\Arm\ApiManagement\Subscriptions\GetApimSubscription` |
| api_management | GET | `/subscriptions/{subscriptionId}/resourceGroups/{rg}/providers/Microsoft.ApiManagement/service/{name}/subscriptions` | `CodebarAg\MicrosoftAzure\Requests\Arm\ApiManagement\Subscriptions\ListApimSubscriptions` |
| api_management | POST | `/subscriptions/{subscriptionId}/resourceGroups/{rg}/providers/Microsoft.ApiManagement/service/{name}/subscriptions/{sid}/regeneratePrimaryKey` | `CodebarAg\MicrosoftAzure\Requests\Arm\ApiManagement\Subscriptions\RegenerateApimSubscriptionPrimaryKey` |
| api_management | POST | `/subscriptions/{subscriptionId}/resourceGroups/{rg}/providers/Microsoft.ApiManagement/service/{name}/subscriptions/{sid}/regenerateSecondaryKey` | `CodebarAg\MicrosoftAzure\Requests\Arm\ApiManagement\Subscriptions\RegenerateApimSubscriptionSecondaryKey` |
| api_management | PATCH | `/subscriptions/{subscriptionId}/resourceGroups/{rg}/providers/Microsoft.ApiManagement/service/{name}/subscriptions/{sid}` | `CodebarAg\MicrosoftAzure\Requests\Arm\ApiManagement\Subscriptions\UpdateApimSubscriptionState` |
| api_management | POST | `/subscriptions/{subscriptionId}/resourceGroups/{rg}/providers/Microsoft.ApiManagement/service/{name}/subscriptions/{sid}/listSecrets` | `CodebarAg\MicrosoftAzure\Requests\Arm\ApiManagement\Subscriptions\ListApimSubscriptionSecrets` |
...
| foundry | PUT | `/agents/{name}` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Agents\ReplaceAgent` |
| foundry | PATCH | `/agents/{name}` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Agents\SetAgentVersionRouting` |
| foundry | PUT | `/agents/{name}/versions/{version}/container` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Agents\UpdateAgentContainer` |
| foundry | GET | `/agents/{name}/versions/{version}/containerOperations` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Agents\ListAgentContainerOperations` |
| foundry | GET | `/agents/{name}/versions/{version}/containerOperations/{operationId}` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Agents\GetAgentContainerOperation` |
...
| foundry | GET | `/conversations` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Conversations\ListConversations` |
...
| foundry | PATCH | `/conversations/{id}` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Conversations\UpdateConversation` |
| foundry | DELETE | `/conversations/{id}` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Conversations\DeleteConversation` |
| foundry | POST | `/conversations/{id}/items` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Conversations\CreateConversationItems` |
| foundry | GET | `/conversations/{id}/items` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Conversations\ListConversationItems` |
| foundry | GET | `/conversations/{id}/items/{itemId}` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Conversations\GetConversationItem` |
| foundry | DELETE | `/conversations/{id}/items/{itemId}` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Conversations\DeleteConversationItem` |
| foundry | POST | `/conversations/{id}/compact` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Conversations\CompactConversation` |
| foundry | POST | `/responses` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Responses\CreateProjectResponse` |
| foundry | GET | `/responses/{id}` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Responses\GetResponse` |
| foundry | DELETE | `/responses/{id}` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Responses\DeleteResponse` |
| foundry | POST | `/responses/{id}/cancel` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Responses\CancelResponse` |
| foundry | GET | `/responses/{id}/input_items` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Responses\ListResponseInputItems` |
...
| foundry | POST | `/toolboxes` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Toolboxes\CreateToolbox` |
| foundry | GET | `/toolboxes` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Toolboxes\ListToolboxes` |
| foundry | GET | `/toolboxes/{name}` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Toolboxes\GetToolbox` |
| foundry | PATCH | `/toolboxes/{name}` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Toolboxes\UpdateToolbox` |
| foundry | DELETE | `/toolboxes/{name}` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Toolboxes\DeleteToolbox` |
| foundry | POST | `/toolboxes/{name}/versions` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Toolboxes\CreateToolboxVersion` |
| foundry | GET | `/toolboxes/{name}/versions` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Toolboxes\ListToolboxVersions` |
| foundry | POST | `/toolboxes/{name}/versions/{version}/mcp` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Toolboxes\ListToolboxMcpTools` |
| foundry | POST | `/toolboxes/{name}/versions/{version}/mcp` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Toolboxes\CallToolboxMcpTool` |
| foundry | POST | `/connections` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Connections\CreateConnection` |
| foundry | GET | `/connections` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Connections\ListConnections` |
| foundry | GET | `/connections/{id}` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Connections\GetConnection` |
| foundry | DELETE | `/connections/{id}` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Connections\DeleteConnection` |
| foundry | POST | `/skills/{name}/versions` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Skills\CreateSkillVersion` |
| foundry | GET | `/skills` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Skills\ListSkills` |
| foundry | GET | `/skills/{name}` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Skills\GetSkill` |
| foundry | GET | `/skills/{name}/versions/{version}` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Skills\GetSkillVersion` |
| foundry | DELETE | `/skills/{name}/versions/{version}` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Skills\DeleteSkillVersion` |
| foundry | PATCH | `/skills/{name}` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Skills\UpdateSkill` |
| foundry | POST | `/memory_stores` | `CodebarAg\MicrosoftAzure\Requests\Foundry\MemoryStores\CreateMemoryStore` |
| foundry | GET | `/memory_stores` | `CodebarAg\MicrosoftAzure\Requests\Foundry\MemoryStores\ListMemoryStores` |
| foundry | GET | `/memory_stores/{id}` | `CodebarAg\MicrosoftAzure\Requests\Foundry\MemoryStores\GetMemoryStore` |
| foundry | PATCH | `/memory_stores/{id}` | `CodebarAg\MicrosoftAzure\Requests\Foundry\MemoryStores\UpdateMemoryStore` |
| foundry | POST | `/memory_stores/{id}/search` | `CodebarAg\MicrosoftAzure\Requests\Foundry\MemoryStores\SearchMemoryStore` |
| foundry | DELETE | `/memory_stores/{id}` | `CodebarAg\MicrosoftAzure\Requests\Foundry\MemoryStores\DeleteMemoryStore` |
| foundry | POST | `/evaluations` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Evaluations\CreateEvaluation` |
| foundry | GET | `/evaluations` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Evaluations\ListEvaluations` |
| foundry | GET | `/evaluations/{id}` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Evaluations\GetEvaluation` |
| foundry | PATCH | `/evaluations/{id}` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Evaluations\UpdateEvaluation` |
| foundry | DELETE | `/evaluations/{id}` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Evaluations\DeleteEvaluation` |
| foundry | PUT | `/schedules/{id}` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Schedules\CreateOrUpdateSchedule` |
| foundry | GET | `/schedules` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Schedules\ListSchedules` |
| foundry | GET | `/schedules/{id}` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Schedules\GetSchedule` |
| foundry | DELETE | `/schedules/{id}` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Schedules\DeleteSchedule` |
| foundry | GET | `/schedules/{id}/runs` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Schedules\ListScheduleRuns` |
| foundry | GET | `/schedules/{id}/runs/{runId}` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Schedules\GetScheduleRun` |
| foundry | PUT | `/datasets/{name}/versions/{version}` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Datasets\CreateOrUpdateDatasetVersion` |
| foundry | GET | `/datasets/{name}/versions/{version}` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Datasets\GetDatasetVersion` |
| foundry | DELETE | `/datasets/{name}/versions/{version}` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Datasets\DeleteDatasetVersion` |
| foundry | PUT | `/indexes/{name}/versions/{version}` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Indexes\CreateOrUpdateIndexVersion` |
| foundry | GET | `/indexes/{name}/versions/{version}` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Indexes\GetIndexVersion` |
| foundry | DELETE | `/indexes/{name}/versions/{version}` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Indexes\DeleteIndexVersion` |
| foundry | POST | `/redteams` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Redteams\CreateRedteam` |
| foundry | GET | `/redteams` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Redteams\ListRedteams` |
| foundry | GET | `/redteams/{name}` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Redteams\GetRedteam` |
...
| keyvault | GET | `/secrets/{name}/versions` | `CodebarAg\MicrosoftAzure\Requests\KeyVault\ListSecretVersions` |
| keyvault | DELETE | `/secrets/{name}` | `CodebarAg\MicrosoftAzure\Requests\KeyVault\DeleteSecret` |
| storage_queue | POST | `/{queue}/messages` | `CodebarAg\MicrosoftAzure\Requests\StorageQueue\SendMessage` |
| storage_queue | GET | `/{queue}/messages` | `CodebarAg\MicrosoftAzure\Requests\StorageQueue\ReceiveMessages` |
| storage_queue | DELETE | `/{queue}/messages/{messageId}` | `CodebarAg\MicrosoftAzure\Requests\StorageQueue\DeleteMessage` |
...
| `CodebarAg\MicrosoftAzure\Data\Arm\ApiManagementServiceData` | `id`, `name`, `location`, `provisioningState`, `gatewayUrl`, `skuName` |
| `CodebarAg\MicrosoftAzure\Data\Arm\ApimSubscriptionData` | `id`, `name`, `displayName`, `scope`, `state`, `ownerId`, `primaryKey`, `secondaryKey`, `createdDate`, `startDate`, `expirationDate`, `endDate`, `notificationDate`, `stateComment`, `allowTracing` |
| `CodebarAg\MicrosoftAzure\Data\Arm\ApimSubscriptionKeysData` | `primaryKey`, `secondaryKey` |
...
| `CodebarAg\MicrosoftAzure\Data\Arm\ProjectConnectionData` | `id`, `name`, `category`, `authType`, `target` |
...
| `CodebarAg\MicrosoftAzure\Data\StorageQueue\QueueMessageData` | `messageId`, `popReceipt`, `insertionTime`, `expirationTime`, `timeNextVisible`, `dequeueCount`, `messageText` |
...
| `CodebarAg\MicrosoftAzure\Data\Payload\AgentVersionRoutingPayload` | `—` | `versionSelector` |
| `CodebarAg\MicrosoftAzure\Data\Payload\ApiManagementServicePayload` | `CodebarAg\MicrosoftAzure\Requests\Arm\ApiManagement\Service\CreateOrUpdateApiManagementService` | `location`, `publisherEmail`, `publisherName`, `skuName`, `skuCapacity` |
| `CodebarAg\MicrosoftAzure\Data\Payload\ApimSubscriptionPayload` | `CodebarAg\MicrosoftAzure\Requests\Arm\ApiManagement\Subscriptions\CreateOrUpdateApimSubscription` | `scope`, `displayName`, `state` |
...
| `CodebarAg\MicrosoftAzure\Data\Payload\ExternalAgentDefinitionPayload` | `—` | `definition` |
| `CodebarAg\MicrosoftAzure\Data\Payload\FoundryProjectPayload` | `CodebarAg\MicrosoftAzure\Requests\Arm\CognitiveServices\Projects\CreateOrUpdateFoundryProject` | `location`, `properties`, `identityType` |
...
| `CodebarAg\MicrosoftAzure\Data\Payload\ProjectConnectionPayload` | `CodebarAg\MicrosoftAzure\Requests\Arm\CognitiveServices\Projects\Connections\CreateOrUpdateProjectConnection` | `category`, `authType`, `target`, `credentials`, `metadata` |
...
| --- | --- | --- | --- |
| `ApiManagementResource` | `createOrUpdate()` | `CodebarAg\MicrosoftAzure\Requests\Arm\ApiManagement\Service\CreateOrUpdateApiManagementService` | `ApiManagementServiceData` |
| `ApiManagementResource` | `service()` | `ApiManagementServiceResource` | `ApiManagementServiceResource` |
| `ApiManagementServiceResource` | `delete()` | `CodebarAg\MicrosoftAzure\Requests\Arm\ApiManagement\Service\DeleteApiManagementService` | `—` |
| `ApiManagementServiceResource` | `get()` | `CodebarAg\MicrosoftAzure\Requests\Arm\ApiManagement\Service\GetApiManagementService` | `ApiManagementServiceData` |
| `ApiManagementServiceResource` | `subscriptions()` | `ApiManagementSubscriptionsResource` | `ApiManagementSubscriptionsResource` |
| `ApiManagementSubscriptionResource` | `listSecrets()` | `CodebarAg\MicrosoftAzure\Requests\Arm\ApiManagement\Subscriptions\ListApimSubscriptionSecrets` | `ApimSubscriptionKeysData` |
| `ApiManagementSubscriptionResource` | `regeneratePrimaryKey()` | `CodebarAg\MicrosoftAzure\Requests\Arm\ApiManagement\Subscriptions\RegenerateApimSubscriptionPrimaryKey` | `—` |
| `ApiManagementSubscriptionResource` | `regenerateSecondaryKey()` | `CodebarAg\MicrosoftAzure\Requests\Arm\ApiManagement\Subscriptions\RegenerateApimSubscriptionSecondaryKey` | `—` |
| `ApiManagementSubscriptionResource` | `revoke()` | `CodebarAg\MicrosoftAzure\Requests\Arm\ApiManagement\Subscriptions\UpdateApimSubscriptionState` | `—` |
| `ApiManagementSubscriptionsResource` | `create()` | `CodebarAg\MicrosoftAzure\Requests\Arm\ApiManagement\Subscriptions\CreateOrUpdateApimSubscription` | `ApimSubscriptionData` |
| `ApiManagementSubscriptionsResource` | `get()` | `CodebarAg\MicrosoftAzure\Requests\Arm\ApiManagement\Subscriptions\GetApimSubscription` | `ApimSubscriptionData` |
| `ApiManagementSubscriptionsResource` | `list()` | `CodebarAg\MicrosoftAzure\Requests\Arm\ApiManagement\Subscriptions\ListApimSubscriptions` | `Collection` |
| `ApiManagementSubscriptionsResource` | `subscription()` | `ApiManagementSubscriptionResource` | `ApiManagementSubscriptionResource` |
...
| `FoundryAgentResource` | `version()` | `FoundryAgentVersionResource` | `FoundryAgentVersionResource` |
| `FoundryAgentVersionResource` | `container()` | `FoundryAgentContainerResource` | `FoundryAgentContainerResource` |
...
| `FoundryAgentsResource` | `replace()` | `GenericJsonPayload` | `array` |
| `FoundryAgentsResource` | `setVersionRouting()` | `AgentVersionRoutingPayload` | `array` |
| `FoundryAgentsResource` | `update()` | `GenericJsonPayload` | `array` |
| `FoundryConnectionsResource` | `create()` | `GenericJsonPayload` | `array` |
| `FoundryConnectionsResource` | `delete()` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Connections\DeleteConnection` | `—` |
| `FoundryConnectionsResource` | `get()` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Connections\GetConnection` | `array` |
| `FoundryConversationsResource` | `compact()` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Conversations\CompactConversation` | `array` |
...
| `FoundryConversationsResource` | `delete()` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Conversations\DeleteConversation` | `—` |
| `FoundryConversationsResource` | `deleteItem()` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Conversations\DeleteConversationItem` | `—` |
| `FoundryConversationsResource` | `get()` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Conversations\GetConversation` | `array` |
| `FoundryConversationsResource` | `getItem()` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Conversations\GetConversationItem` | `array` |
| `FoundryConversationsResource` | `listItems()` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Conversations\ListConversationItems` | `Collection` |
| `FoundryConversationsResource` | `update()` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Conversations\UpdateConversation` | `array` |
| `FoundryDatasetsResource` | `createOrUpdateVersion()` | `GenericJsonPayload` | `array` |
| `FoundryDatasetsResource` | `deleteVersion()` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Datasets\DeleteDatasetVersion` | `—` |
| `FoundryDatasetsResource` | `getVersion()` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Datasets\GetDatasetVersion` | `array` |
| `FoundryEvaluationsResource` | `create()` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Evaluations\CreateEvaluation` | `array` |
| `FoundryEvaluationsResource` | `delete()` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Evaluations\DeleteEvaluation` | `—` |
| `FoundryEvaluationsResource` | `get()` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Evaluations\GetEvaluation` | `array` |
| `FoundryEvaluationsResource` | `update()` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Evaluations\UpdateEvaluation` | `array` |
| `FoundryIndexesResource` | `createOrUpdateVersion()` | `GenericJsonPayload` | `array` |
| `FoundryIndexesResource` | `deleteVersion()` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Indexes\DeleteIndexVersion` | `—` |
| `FoundryIndexesResource` | `getVersion()` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Indexes\GetIndexVersion` | `array` |
| `FoundryMemoryStoresResource` | `create()` | `CodebarAg\MicrosoftAzure\Requests\Foundry\MemoryStores\CreateMemoryStore` | `array` |
| `FoundryMemoryStoresResource` | `delete()` | `CodebarAg\MicrosoftAzure\Requests\Foundry\MemoryStores\DeleteMemoryStore` | `—` |
| `FoundryMemoryStoresResource` | `get()` | `CodebarAg\MicrosoftAzure\Requests\Foundry\MemoryStores\GetMemoryStore` | `array` |
| `FoundryMemoryStoresResource` | `search()` | `CodebarAg\MicrosoftAzure\Requests\Foundry\MemoryStores\SearchMemoryStore` | `array` |
| `FoundryMemoryStoresResource` | `update()` | `CodebarAg\MicrosoftAzure\Requests\Foundry\MemoryStores\UpdateMemoryStore` | `array` |
| `FoundryProjectsResource` | `connections()` | `ProjectConnectionsResource` | `ProjectConnectionsResource` |
...
| `FoundryRedteamsResource` | `create()` | `GenericJsonPayload` | `array` |
| `FoundryRedteamsResource` | `get()` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Redteams\GetRedteam` | `array` |
...
| `FoundryResource` | `connections()` | `FoundryConnectionsResource` | `FoundryConnectionsResource` |
| `FoundryResource` | `conversations()` | `FoundryConversationsResource` | `FoundryConversationsResource` |
| `FoundryResource` | `datasets()` | `FoundryDatasetsResource` | `FoundryDatasetsResource` |
| `FoundryResource` | `evaluations()` | `FoundryEvaluationsResource` | `FoundryEvaluationsResource` |
| `FoundryResource` | `indexes()` | `FoundryIndexesResource` | `FoundryIndexesResource` |
| `FoundryResource` | `memoryStores()` | `FoundryMemoryStoresResource` | `FoundryMemoryStoresResource` |
| `FoundryResource` | `redteams()` | `FoundryRedteamsResource` | `FoundryRedteamsResource` |
| `FoundryResource` | `responses()` | `FoundryResponsesResource` | `FoundryResponsesResource` |
| `FoundryResource` | `schedules()` | `FoundrySchedulesResource` | `FoundrySchedulesResource` |
| `FoundryResource` | `skills()` | `FoundrySkillsResource` | `FoundrySkillsResource` |
| `FoundryResource` | `threads()` | `FoundryThreadsResource` | `FoundryThreadsResource` |
| `FoundryResource` | `toolboxes()` | `FoundryToolboxesResource` | `FoundryToolboxesResource` |
| `FoundryResponsesResource` | `cancel()` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Responses\CancelResponse` | `array` |
| `FoundryResponsesResource` | `create()` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Responses\CreateProjectResponse` | `array` |
| `FoundryResponsesResource` | `delete()` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Responses\DeleteResponse` | `—` |
| `FoundryResponsesResource` | `get()` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Responses\GetResponse` | `array` |
| `FoundryResponsesResource` | `listInputItems()` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Responses\ListResponseInputItems` | `Collection` |
| `FoundryScheduleRunsResource` | `get()` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Schedules\GetScheduleRun` | `array` |
| `FoundryScheduleRunsResource` | `list()` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Schedules\ListScheduleRuns` | `Collection` |
| `FoundrySchedulesResource` | `createOrUpdate()` | `GenericJsonPayload` | `array` |
| `FoundrySchedulesResource` | `delete()` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Schedules\DeleteSchedule` | `—` |
| `FoundrySchedulesResource` | `get()` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Schedules\GetSchedule` | `array` |
| `FoundrySchedulesResource` | `runs()` | `FoundryScheduleRunsResource` | `FoundryScheduleRunsResource` |
| `FoundrySkillsResource` | `createVersion()` | `GenericJsonPayload` | `array` |
| `FoundrySkillsResource` | `deleteVersion()` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Skills\DeleteSkillVersion` | `—` |
| `FoundrySkillsResource` | `get()` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Skills\GetSkill` | `array` |
| `FoundrySkillsResource` | `getVersion()` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Skills\GetSkillVersion` | `array` |
| `FoundrySkillsResource` | `setDefaultVersion()` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Skills\UpdateSkill` | `array` |
...
| `FoundryToolboxesResource` | `callMcpTool()` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Toolboxes\CallToolboxMcpTool` | `array` |
| `FoundryToolboxesResource` | `create()` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Toolboxes\CreateToolbox` | `array` |
| `FoundryToolboxesResource` | `createVersion()` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Toolboxes\CreateToolboxVersion` | `array` |
| `FoundryToolboxesResource` | `delete()` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Toolboxes\DeleteToolbox` | `—` |
| `FoundryToolboxesResource` | `get()` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Toolboxes\GetToolbox` | `array` |
| `FoundryToolboxesResource` | `listMcpTools()` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Toolboxes\ListToolboxMcpTools` | `array` |
| `FoundryToolboxesResource` | `listVersions()` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Toolboxes\ListToolboxVersions` | `Collection` |
| `FoundryToolboxesResource` | `setDefaultVersion()` | `CodebarAg\MicrosoftAzure\Requests\Foundry\Toolboxes\UpdateToolbox` | `array` |
...
| `ProjectConnectionsResource` | `createOrUpdate()` | `CodebarAg\MicrosoftAzure\Requests\Arm\CognitiveServices\Projects\Connections\CreateOrUpdateProjectConnection` | `ProjectConnectionData` |
| `ProjectConnectionsResource` | `delete()` | `CodebarAg\MicrosoftAzure\Requests\Arm\CognitiveServices\Projects\Connections\DeleteProjectConnection` | `—` |
| `ProjectConnectionsResource` | `get()` | `CodebarAg\MicrosoftAzure\Requests\Arm\CognitiveServices\Projects\Connections\GetProjectConnection` | `ProjectConnectionData` |
| `ProjectConnectionsResource` | `list()` | `CodebarAg\MicrosoftAzure\Requests\Arm\CognitiveServices\Projects\Connections\ListProjectConnections` | `Collection` |
...
| `SecretsResource` | `versions()` | `CodebarAg\MicrosoftAzure\Requests\KeyVault\ListSecretVersions` | `Collection` |
...
| `StorageAccountResource` | `queue()` | `StorageQueueResource` | `StorageQueueResource` |
| `StorageAccountResource` | `queues()` | `QueuesResource` | `QueuesResource` |
...
| `StorageQueueResource` | `deleteMessage()` | `CodebarAg\MicrosoftAzure\Requests\StorageQueue\DeleteMessage` | `—` |
| `StorageQueueResource` | `receiveMessages()` | `CodebarAg\MicrosoftAzure\Requests\StorageQueue\ReceiveMessages` | `Collection` |
| `StorageQueueResource` | `sendMessage()` | `CodebarAg\MicrosoftAzure\Requests\StorageQueue\SendMessage` | `QueueMessageData` |
