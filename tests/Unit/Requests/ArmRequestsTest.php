...
dataset('arm request endpoints', [
    ...
    'CancelSubscription' => [
        fn () => new CancelSubscription('sub-1'),
        '/subscriptions/sub-1/providers/Microsoft.Subscription/cancel',
        ApiVersion::ARM_SUBSCRIPTIONS,
    ],
...
it('resolves ARM request endpoints and api-version query', function (callable $factory, string $endpoint, ApiVersion $apiVersion): void {
    /** @var Request $request */
    $request = $factory();
