...
final class StorageAccountData extends AzureData
{
    public function __construct(
        ...
        public ?string $primaryBlobEndpoint = null,
    ...
    public static function fromAzure(array $data): self
    {
        ...
        return new self(
            ...
            primaryBlobEndpoint: Field::arrNullableString($data, 'properties.primaryEndpoints.blob'),
