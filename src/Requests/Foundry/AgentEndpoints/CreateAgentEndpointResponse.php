...
final class CreateAgentEndpointResponse extends FoundryAgentsRequest implements FoundryFeatureRequest, HasBody
{
    ...
    {
        return '/agents/'.$this->agentName.'/endpoint/protocols/openai/responses';
    }
