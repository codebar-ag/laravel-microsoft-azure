...
final class ListToolboxMcpTools extends FoundryAgentsRequest implements FoundryFeatureRequest, HasBody
{
    ...
    {
        return (new McpJsonRpcPayload('tools/list'))->toAzureBody();
    }
}
