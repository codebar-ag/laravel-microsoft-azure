...
final class UpdateAgentContainer extends FoundryAgentsRequest implements FoundryFeatureRequest, HasBody
{
    ...
    {
        return '/agents/'.$this->agentName.'/versions/'.$this->version.'/container';
    }
