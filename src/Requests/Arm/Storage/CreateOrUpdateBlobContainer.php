...
final class CreateOrUpdateBlobContainer extends StorageRequest implements HasBody
{
    use HasJsonBody;
    ...
    public function __construct(
        ...
        public readonly BlobContainerPayload $payload,
    ) {}
    ...
    public function resolveEndpoint(): string
    {
        return '/subscriptions/'.$this->subscriptionId
            ...
            .'/blobServices/default/containers/'.$this->containerName;
    }
