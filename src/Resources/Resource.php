...
abstract class Resource
{
    ...
    protected function sendStorageQueue(Request $request, string $accountName, ?string $accountKey = null): Response
    {
        return $this->send($request, $this->client->storageQueue($accountName, $accountKey));
    }
