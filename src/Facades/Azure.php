 ...
 * @method static RoleDefinitionsResource roleDefinitions(string $subscriptionId)
 * @method static ResourceProvidersResource resourceProviders(string $subscriptionId)
 ...
 * @method static ApiManagementResource apiManagement(string $subscriptionId, string $resourceGroup)
