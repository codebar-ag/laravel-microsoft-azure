...
enum TokenAudience: string
{
    ...
    case FoundryDataPlane = 'foundry_data_plane';
    ...
    case StorageDataPlane = 'storage_data_plane';
    ...
    public function scope(?string $host = null): string
    {
        return match ($this) {
            ...
            self::FoundryDataPlane => 'https://ai.azure.com/.default',
            ...
            self::StorageDataPlane => 'https://storage.azure.com/.default',
        };
    }
}
